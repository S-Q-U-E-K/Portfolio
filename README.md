Archhop.sh = A bash script to replace the currently installed linux distribution with Arch linux, while maintaining /home. Formatted with BTRFS to allow for snapshotting of home and root.
